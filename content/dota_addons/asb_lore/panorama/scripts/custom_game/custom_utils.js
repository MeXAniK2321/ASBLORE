...
function SetImageForPanelDemonNasral(pPanel, sHeroName)
{
	if(pPanel)
	{
		...
		else if (sHeroName == "npc_dota_hero_kez")
		{
		...
		else if (sHeroName == "npc_dota_hero_slardar")
		{
			pPanel.SetImage( "file://{images}/heroes/scp682.png" );
		}
		else if (sHeroName == "npc_dota_hero_mirana")
		{
			pPanel.SetImage( "file://{images}/heroes/kiana.png" );
		}
