...
function UpdatePlayer( teamPanel, playerId )
{
	...
	{
		GameUI.CustomUIConfig().SetImageForPanelDemonNasral(playerPortrait, playerInfo.player_selected_hero);
	...
	{
		GameUI.CustomUIConfig().SetImageForPanelDemonNasral(playerPortrait, "npc_dota_hero_" + playerInfo.possible_hero_selection);
