...
function muramasa_tsumukari_combo:OnSpellStart()
	...
	Timers:CreateTimer(2.3, function() 
		 ...
		 ParticleManager:DestroyParticle(firering, true)
		 ParticleManager:ReleaseParticleIndex(firering)
	end)
	...
	caster:AddNewModifier(caster, self, "modifier_merlin_self_pause", {duration = 4}) 
