...
function invisible_hand:OnSpellStart()
	-- unit identifier
	...
	local projectile_name = "particles/invisible_hand.vpcf"
...
function invisible_hand:OnProjectileHit( hTarget, vLocation )
...
function invisible_hand:Hit( target, dragonform )
	local caster = self:GetCaster()
...
--------------------------------------------------------------------------------
function invisible_hand:PlayEffects1()
	-- Get Resources
...
function invisible_hand:PlayEffects2( target )
	-- Get Resources
