...
function goju_hollow_purple:CastFilterResultLocation(vLocation)
...
function goju_hollow_purple_test:OnAbilityPhaseStart()
    self.fSpeed = self.fSpeed or 2000
...
function GojoStartMotion(self)
    if IsNotNull(self)
        ...
        --===============================================================================--
        if self.ability.Settings then
            self.ability:Settings()
        else
            return self:Destroy()
        end
        --===============================================================================--
