...
function modifier_gojo_hollow_nuke:StagesThinking()
    ...
    if self:GetStage() == GOJO_STAGE_PRE_EXPLO then
        ...
        Timers:CreateTimer(0.5, function()
            ParticleManager:DestroyParticle(iHollowNukeEffectBefore, true)
...
goju_hollow_nuke = goju_hollow_nuke or class({})

function goju_hollow_nuke:GetAOERadius()
    return 10000
end
function goju_hollow_nuke:OnSpellStart()
