...
--------------------------------------------------------------------------------
-- Ability Start
function ryen_hoka:OnUpgrade()
    local ability = self:GetCaster():FindAbilityByName("bloodseeker_blood_rite_lua")
    if ability and ability:GetLevel() < self:GetLevel() then
        ability:SetLevel(self:GetLevel())
    end
end
function ryen_hoka:OnSpellStart()
	-- unit identifier
	...
	-- load data
	local projectile_name = "particles/ryen_hoka.vpcf"
...
--------------------------------------------------------------------------------
-- Projectile
function ryen_hoka:OnProjectileHitHandle( target, location, projectile )
...
--------------------------------------------------------------------------------
function ryen_hoka:PlayEffects( target, direction )
	-- Get Resources
