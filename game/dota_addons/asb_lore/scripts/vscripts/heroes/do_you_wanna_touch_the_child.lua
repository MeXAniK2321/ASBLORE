do_you_wanna_touch_the_child = class({})
...
--------------------------------------------------------------------------------
-- Ability Start
function do_you_wanna_touch_the_child:OnSpellStart()
	-- unit identifier
...
-- Helper
function do_you_wanna_touch_the_child:Hit( target, dragonform )
	local caster = self:GetCaster()
	...
	local sound_cast = "frisk.7_1"
	EmitSoundOn( sound_cast, target )
end

--------------------------------------------------------------------------------
-- Projectile
function do_you_wanna_touch_the_child:OnProjectileHit( target, location )
...
--------------------------------------------------------------------------------
function do_you_wanna_touch_the_child:PlayEffects( target, dragonform )
	-- Get Resources
	local particle_cast = "particles/do_you_wanna_touch_the_child.vpcf"
