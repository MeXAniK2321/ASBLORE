...
-- Helper
function geass_command:Hit( target, dragonform )
	local caster = self:GetCaster()
	...
	-- load data
	local damage = self:GetAbilityDamage() + self:GetCaster():FindTalentValue("special_bonus_lelouch_25")
...
--------------------------------------------------------------------------------
-- Projectile
function geass_command:OnProjectileHit( target, location )
...
--------------------------------------------------------------------------------
function geass_command:PlayEffects( target, dragonform )
	-- Get Resources
