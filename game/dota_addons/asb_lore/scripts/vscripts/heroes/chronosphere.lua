LinkLuaModifier("modifier_chronosphere_speed_lua", "modifiers/modifier_chronosphere_speed_lua.lua", LUA_MODIFIER_MOTION_NONE)
...
function cooldown( keys )
	...
	keys.ability:StartCooldown(keys.ability:GetSpecialValueFor("Coldown"))
end