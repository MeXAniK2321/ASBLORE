...
function issei_laser:OnSpellStart()
	-- unit identifier
...
if self:GetCaster():HasModifier( "modifier_juggernaut_drive" ) then
self.projectile_name = "particles/issei_laser_juggernaut.vpcf"
local sound_cast = "issei.login_smasher"
EmitSoundOn( sound_cast, self:GetCaster() )
else
	local sound_cast = "issei.6"
EmitSoundOn( sound_cast, self:GetCaster() )
	self.projectile_name = "particles/issei_laser.vpcf"
	end
	...
	local sound_projectile = "issei.6_1"
	EmitSoundOn( sound_projectile, self:GetCaster() )
end

--------------------------------------------------------------------------------
-- Projectile
function issei_laser:OnProjectileHitHandle( target, location, projectile )
...
--------------------------------------------------------------------------------
function issei_laser:PlayEffects( target, direction )
	-- Get Resources
