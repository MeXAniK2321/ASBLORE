...
--------------------------------------------------------------------------------
-- Ability Start
function kinton_lightning:OnUpgrade()
    if IsServer() then
       
            if self:IsActivated() and not self:GetCaster():HasModifier("modifier_kinton") then
                self:SetActivated(false)
            end
        
    end
end
function kinton_lightning:OnSpellStart()
	-- unit identifier
...
-- Helper
function kinton_lightning:Hit( target, dragonform )
	local caster = self:GetCaster()
	...
	local sound_cast = "mori.8_2"
	EmitSoundOn( sound_cast, target )
end

--------------------------------------------------------------------------------
-- Projectile
function kinton_lightning:OnProjectileHit( target, location )
...
--------------------------------------------------------------------------------
function kinton_lightning:PlayEffects( target, dragonform )
	-- Get Resources
