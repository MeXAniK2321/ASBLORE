function torrent_bubble_allies( keys )
	...
	local particleName = "particles/kunkka_spell_torrent_bubbles1.vpcf"
	...
	for k, v in pairs( allHeroes ) do
		if v:GetPlayerID() and v:GetTeam() == caster:GetTeam() then
			...
			EmitSoundOnClient( "yoshino.tornado_pre", PlayerResource:GetPlayer( v:GetPlayerID() ) )
...
function torrent_emit_sound( keys )
	...
	EmitSoundOn( "yoshino.tornado", dummy )
