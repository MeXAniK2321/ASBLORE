...
modifier_ichigoE_target_knockback = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_ichigoE_target_knockback:IsHidden() return false end

function modifier_ichigoE_target_knockback:IsPurgable() return false end

function modifier_ichigoE_target_knockback:GetAttributes() return MODIFIER_ATTRIBUTE_MULTIPLE end
--------------------------------------------------------------------------------
-- Initializations
function modifier_ichigoE_target_knockback:OnCreated(kv)
    if IsServer() then
        ...
        -- references
        self.distance = kv.distance or 400
...
function modifier_ichigoE_target_knockback:OnRefresh(kv) if not IsServer() then return end end

function modifier_ichigoE_target_knockback:OnDestroy(kv)
...
--------------------------------------------------------------------------------
-- Setter
function modifier_ichigoE_target_knockback:SetEndCallback(func) self.EndCallback = func end

--------------------------------------------------------------------------------
-- Status Effects
function modifier_ichigoE_target_knockback:CheckState()
...
--------------------------------------------------------------------------------
-- Motion effects
function modifier_ichigoE_target_knockback:UpdateHorizontalMotion(me, dt)
...
function modifier_ichigoE_target_knockback:OnHorizontalMotionInterrupted()
    if IsServer() then
...
function modifier_ichigoE_target_knockback:UpdateVerticalMotion(me, dt)
    -- set time
...
function modifier_ichigoE_target_knockback:OnVerticalMotionInterrupted()
    if IsServer() then
        self.interrupted = true
        self:Destroy()
    end
