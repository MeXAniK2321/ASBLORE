...
LinkLuaModifier( "modifier_wisp_ambient", "modifiers/modifier_wisp_ambient", LUA_MODIFIER_MOTION_NONE )
...
function dark_willow_terrorize_lua:PlayEffects1( point, radius )
	-- Get Resources
	local particle_cast = "particles/dark_willow_wisp_spell_marker1.vpcf"
	...
	-- play sound
	local sound_cast1 = "Accel.plasma3"
	local sound_cast2 = "Accel.plasma1"
	local sound_cast3 = "Accel.plasma2"
...
function dark_willow_terrorize_lua:PlayEffects2()
	-- Get Resources
	local particle_cast = "particles/dark_willow_wisp_spell_channel1.vpcf"
...
function dark_willow_terrorize_lua:PlayEffects3( point, radius, number )
	-- Get Resources
	local particle_cast = "particles/dark_willow_wisp_spell1.vpcf"
