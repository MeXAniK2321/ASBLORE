...
function modifier_item_asha_tear:IsHidden() return true end
function modifier_item_asha_tear:AllowIllusionDuplicate() return true end
function modifier_item_asha_tear:IsPurgable() return false end
...
function modifier_item_asha_tear:GetModifierSpellAmplify_Percentage()
     if self:GetParent():HasItemInInventory("item_vongolla_primo_ring") or self:GetParent():HasItemInInventory("item_crucible_of_the_executioner") then return 0 end
