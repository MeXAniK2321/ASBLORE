...
function modifier_will_of_the_fallen:IsHidden() return true end
function modifier_will_of_the_fallen:RemoveOnDeath() return false end
function modifier_will_of_the_fallen:IsPurgable() return false end
function modifier_will_of_the_fallen:OnCreated(table)
	...
	self.int_cur = self.parent:GetIntellect()
	self.cast_range = self.ability:GetSpecialValueFor('cast_range')
	self.dmg_proc = self.ability:GetSpecialValueFor('dmg_proc_amount')
	self.spell_amp = self.ability:GetSpecialValueFor('damage_increase')
...
function modifier_will_of_the_fallen:GetModifierSpellAmplify_Percentage()
	return self.spell_amp
end
function modifier_will_of_the_fallen:OnTakeDamage(keys)
	if IsServer() and not self.parent:HasModifier("modifier_will_of_the_fallen_cd") then
	local caster = self:GetCaster()
	local damage = keys.original_damage
	
	if damage > self.dmg_proc then
		if keys.attacker == self.parent and keys.damage_category == 0 and keys.inflictor ~= self:GetAbility() then
			...
			EmitSoundOn("fallen.slash", target)
			      ...
			      elseif self:GetParent():HasModifier("modifier_will_of_the_fallen_ultimate") then
			        ...
			        self.parent:Heal( self.int_cur * 0.5, self:GetParent() )
			      else
			        caster:AddNewModifier(caster, self:GetAbility(), "modifier_will_of_the_fallen_cd", {duration = 1.3})
				    keys.unit:AddNewModifier(caster, self:GetAbility(), "modifier_will_of_the_fallen_int_overflow", {duration = 10})
...
function modifier_will_of_the_fallen:GetModifierHealthBonus()
    return self.parent:HasItemInInventory("item_yoru")
           and 0
           or self.hp
end
...
function modifier_will_of_the_fallen_slow:IsDebuff() return true end
function modifier_will_of_the_fallen_slow:IsStunDebuff() return false end
function modifier_will_of_the_fallen_slow:IsHidden() return false end
function modifier_will_of_the_fallen_slow:IsPurgable() return true end
...
--------------------------------------------------------------------------------
-- Classifications
function modifier_will_of_the_fallen_int_overflow:IsHidden() return false end
function modifier_will_of_the_fallen_int_overflow:IsDebuff() return true end
function modifier_will_of_the_fallen_int_overflow:IsStunDebuff() return false end
function modifier_will_of_the_fallen_int_overflow:IsPurgable() return true end
--------------------------------------------------------------------------------
-- Initializations
...
--------------------------------------------------------------------------------
-- Classifications
function modifier_will_of_the_fallen_aura:IsHidden() return true end
function modifier_will_of_the_fallen_aura:IsDebuff() return false end
function modifier_will_of_the_fallen_aura:IsStunDebuff() return false end
function modifier_will_of_the_fallen_aura:IsPurgable() return false end
function modifier_will_of_the_fallen_aura:RemoveOnDeath() return false end
...
function modifier_will_of_the_fallen_base:IsHidden() return true end
function modifier_will_of_the_fallen_base:RemoveOnDeath() return true end
function modifier_will_of_the_fallen_base:AllowIllusionDuplicate() return false end
function modifier_will_of_the_fallen_base:IsPurgable() return false end
