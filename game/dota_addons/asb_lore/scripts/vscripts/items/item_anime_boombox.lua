...
function modifier_item_anime_boombox:IsHidden() return true end
...
function modifier_item_anime_boombox:CheckState()
	local state = { [MODIFIER_STATE_PROVIDES_VISION] = false, }

	return state
end
function modifier_item_anime_boombox:GetTexture()
	return "boombox"
end
