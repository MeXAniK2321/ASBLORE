...
item_yamato = item_yamato or class({})
...
modifier_yamato = modifier_yamato or class({})

function modifier_yamato:IsHidden() return true end
function modifier_yamato:RemoveOnDeath() return false end
function modifier_yamato:IsPurgable() return false end
