...
item_accel_pribor = item_accel_pribor or class({})
...
modifier_accel_pribor = modifier_accel_pribor or class({})

function modifier_accel_pribor:IsHidden() return true end
function modifier_accel_pribor:RemoveOnDeath() return false end
function modifier_accel_pribor:IsPurgable() return false end
