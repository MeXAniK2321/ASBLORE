...
function modifier_box_of_pandora:IsHidden() return true end
function modifier_box_of_pandora:RemoveOnDeath() return false end
function modifier_box_of_pandora:IsPurgable() return false end
function modifier_box_of_pandora:GetAttributes() return MODIFIER_ATTRIBUTE_MULTIPLE end
