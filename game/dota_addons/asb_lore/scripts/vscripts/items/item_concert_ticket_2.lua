item_concert_ticket_2 = class({})


function item_concert_ticket_2:OnSpellStart()
 local caster = self:GetCaster()
 self.caster = caster
 self.bonus_gold = 1750
...
if self.shit == 1 then
EmitSoundOnClient("new.year_theme_3", Player) 
else
EmitSoundOnClient("new.year_theme_4", Player) 
end
end

function item_concert_ticket_2:StopAllMusic()
