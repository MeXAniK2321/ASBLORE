modifier_blade_fury_lua = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_blade_fury_lua:IsHidden()
	return false
end

function modifier_blade_fury_lua:IsDebuff()
	return false
end

function modifier_blade_fury_lua:IsPurgable()
	return false
end

function modifier_blade_fury_lua:DestroyOnExpire()
	return false
end
--------------------------------------------------------------------------------
-- Initializations
function modifier_blade_fury_lua:OnCreated( kv )
	-- references
...
function modifier_blade_fury_lua:OnRefresh( kv )
	-- references
	self.tick = self:GetAbility():GetSpecialValueFor( "blade_fury_damage_tick" ) -- special value
	self.radius = self:GetAbility():GetSpecialValueFor( "blade_fury_radius" ) -- special value
	self.dps = self:GetAbility():GetSpecialValueFor( "blade_fury_damage" ) -- special value
...
function modifier_blade_fury_lua:OnDestroy( kv )
	-- Stop effects
	local sound_cast = "Sound.hurricane"
	StopSoundOn( sound_cast, self:GetParent() )
end

--------------------------------------------------------------------------------
-- Status Effects
function modifier_blade_fury_lua:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Interval Effects
function modifier_blade_fury_lua:OnIntervalThink()
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_blade_fury_lua:PlayEffects()
		-- Get Resources
...
function modifier_blade_fury_lua:PlayEffects2( target )
