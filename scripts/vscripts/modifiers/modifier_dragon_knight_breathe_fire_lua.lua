...
function modifier_dragon_knight_breathe_fire_lua:GetModifierProvidesFOWVision()
	return 1
end
--------------------------------------------------------------------------------
-- Status Effects
function modifier_dragon_knight_breathe_fire_lua:CheckState()
	local state = {
...
function modifier_dragon_knight_breathe_fire_lua:PlayEffects()
	-- Get Resources
	local particle_cast1 = "particles/dark_willow_wisp_spell_debuff1.vpcf"
	local particle_cast2 = "particles/dark_willow_wisp_spell_fear_debuff1.vpcf"
