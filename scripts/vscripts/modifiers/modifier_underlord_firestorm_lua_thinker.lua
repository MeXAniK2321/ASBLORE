...
function modifier_underlord_firestorm_lua_thinker:OnCreated( kv )
    ...
    local damage = self.ability:GetSpecialValueFor( "wave_damage_x" )
	self.burn_damage = self.ability:GetSpecialValueFor( "burn_damage_x" )
	else
	-- references
...
function modifier_underlord_firestorm_lua_thinker:PlayEffects()
	-- Get Resources
	local particle_cast = "particles/abyssal_underlord_firestorm_wave1.vpcf"
