...
function modifier_crystal_maiden_freezing_field_lua:PlayEffects1()
	local particle_cast = "particles/maiden_freezing_field_snow_arcana2.vpcf"
	self.sound_cast = "shu.last1"
...
function modifier_crystal_maiden_freezing_field_lua:PlayEffects2( point )
	-- Play particles
	local particle_cast = "particles/maiden_freezing_field_explosion_arcana11.vpcf"
