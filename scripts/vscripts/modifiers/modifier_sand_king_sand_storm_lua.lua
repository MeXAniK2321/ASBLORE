...
function modifier_sand_king_sand_storm_lua:PlayEffects( radius )
	-- Get Resources
	local particle_cast = "particles/naga_siren_song_aura1.vpcf"
	local sound_cast = "Vocaloid_Rin_music_"..RandomInt(1,3)
...
function modifier_sand_king_sand_storm_lua:StopEffects()
	...
	-- Stop sound
	local sound_cast = ""
	StopSoundOn( "Vocaloid_Rin_music_1", self:GetParent() )
	StopSoundOn( "Vocaloid_Rin_music_2", self:GetParent() )
	StopSoundOn( "Vocaloid_Rin_music_3", self:GetParent() )
