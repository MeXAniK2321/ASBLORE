item_concert_ticket_3 = class({})


function item_concert_ticket_3:OnSpellStart()
 local caster = self:GetCaster()
 self.caster = caster
 self.bonus_gold = 2500
...
if self.shit == 1 then
EmitSoundOnClient("new.year_theme_5", Player) 
else
EmitSoundOnClient("new.year_theme_6", Player) 
end
end

function item_concert_ticket_3:StopAllMusic()
