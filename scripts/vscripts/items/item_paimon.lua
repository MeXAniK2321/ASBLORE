...
function modifier_paimon:GetModifierPercentageCooldown()
    if self:GetParent():HasItemInInventory("item_octarine_core") or self:GetParent():HasItemInInventory("item_watch") then self.cd = 0 return end
...
function modifier_paimon_buff:GetModifierPercentageCooldown()
    ...
    if self:GetParent():HasItemInInventory("item_octarine_core") or self:GetParent():HasItemInInventory("item_watch") or self:GetParent():HasItemInInventory("item_paimon") then self.cd = 0 return end
	self.cd = 15
    return self.cd
end
