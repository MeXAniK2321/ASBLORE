...
function item_dante_sword:OnSpellStart()
 ...
 caster:AddNewModifier(caster, self, "modifier_dante_uebok", { duration = 5 } )
	...
	modifier_dante_uebok = class({})


function modifier_dante_uebok:IsHidden()
    return true
end
function modifier_dante_uebok:RemoveOnDeath() return true end
function modifier_dante_uebok:IsPurgable()
    return false
end
modifier_dante_sword = class({})


function modifier_dante_sword:IsHidden()
    return true
end
function modifier_dante_sword:RemoveOnDeath() return false end
function modifier_dante_sword:IsPurgable()
    return false
end
...
function modifier_dante_sword:GetAttributes()
