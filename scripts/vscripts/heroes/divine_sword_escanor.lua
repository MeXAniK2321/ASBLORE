...
--------------------------------------------------------------------------------
-- Ability Start
function divine_sword_escanor:OnSpellStart()
	-- unit identifier
...
-- Helper
function divine_sword_escanor:Hit( target, dragonform )
	local caster = self:GetCaster()
	...
	local sound_cast = "escanor.5_1"
	EmitSoundOn( sound_cast, target )
end

--------------------------------------------------------------------------------
-- Projectile
function divine_sword_escanor:OnProjectileHit( target, location )
...
--------------------------------------------------------------------------------
function divine_sword_escanor:PlayEffects( target, dragonform )
	-- Get Resources
	local particle_cast = "particles/divine_sword_escanor.vpcf"
