unthinkable_present = class({})
LinkLuaModifier( "modifier_unthinkable_present", "modifiers/modifier_unthinkable_present", LUA_MODIFIER_MOTION_NONE )
...
--------------------------------------------------------------------------------
-- Ability Start
function unthinkable_present:OnSpellStart()
	-- unit identifier
...
-- Helper
function unthinkable_present:Hit( target, dragonform )
	local caster = self:GetCaster()
	...
	target:AddNewModifier(
		...
		self, -- ability source
		"modifier_unthinkable_present", -- modifier name
...
--------------------------------------------------------------------------------
-- Projectile
function unthinkable_present:OnProjectileHit( target, location )
...
--------------------------------------------------------------------------------
function unthinkable_present:PlayEffects( target, dragonform )
	-- Get Resources
	local particle_cast = ""
	-- Get Data
