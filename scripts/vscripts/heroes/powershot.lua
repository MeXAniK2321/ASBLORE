function powershot_initialize( keys )
	...
	local point = keys.target_points[1] + (caster:GetForwardVector() * 1) 
...
function powershot_start_traverse( keys )
	...
	local caster = keys.caster
	local ability = keys.ability
	local startAttackSound = "Brs.5_sfx"
	local startTraverseSound = "Brs.5_sfx"
	local projectileName = "particles/windrunner_spell_powershot1.vpcf"
