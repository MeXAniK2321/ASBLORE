...
--------------------------------------------------------------------------------
-- Ability Start
function knife_toss:OnSpellStart()
	-- unit identifier
	...
	-- load data
	local projectile_name = "particles/chara_knife_toss.vpcf"
	...
	EmitSoundOn( "chara.1", caster )

end

--------------------------------------------------------------------------------
-- Projectile
function knife_toss:OnProjectileHit_ExtraData( hTarget, vLocation, extraData )
