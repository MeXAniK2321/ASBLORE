...
function appolon_bow:IsStealable()
   return false
end
...
self.bow_fx = 	ParticleManager:CreateParticle("particles/ikaros_appolon.vpcf", PATTACH_CUSTOMORIGIN_FOLLOW, self:GetCaster())
...
modifier_appolon_bow_thinker = class ({})
